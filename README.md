...
### 关于驱动盘
 ...
 驱动盘等级上限为15级（A为12级，B为9级），每提升3级将会在当前副词条中随机将一个副词条的等级+1(如果副词条数小于最大词条数那么将出现一条新的副词条)。
 故等级>=3级的驱动盘必定达到了最大副词条上限，不会出现新的副词条，只会升级已有的副词条的等级。
 S级驱动盘初始3~4副词条，A级初始2~3，B级初始1~2。
 S级驱动盘最大4副词条，A级最大3副词条，B级最大2副词条。
